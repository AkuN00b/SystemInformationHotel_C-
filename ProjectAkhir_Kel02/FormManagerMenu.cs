...
using ProjectAkhir_Kel02.Forms.Manager;
...
namespace ProjectAkhir_Kel02
{
    public partial class FormManagerMenu : Form
    {
        ...
        // Constructor
        public FormManagerMenu(string[] data)
        {
            InitializeComponent();
        ...
        {
            ActivateButton(sender, RGBColors.color1);
            OpenChildForm(new FormMenuReportTransaksiKamar());
        }
        ...
        private void btnReportTransaksiMenu_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color2);
            OpenChildForm(new FormMenuReportTransaksiMenu());
        }

        private void btnReportTransaksiRuangan_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color3);
            OpenChildForm(new FormMenuReportTransaksiRuangan());
        }
    }
}
